module.exports = function(jstatic) {
    ...
    jstatic.registerGenerator("permalink", function(iter, params, flow, depends, data) {
        ...
        if(_.isString(params.link)) {
            ...
            grunt.fail.warn("generator#permalink: parameter func must be a function or a string");
        }
    ...
    jstatic.registerGenerator("inlinegen", function(iter, params, flow, depends, data) {
        var inGen = params.iter;
        if(_.isUndefined(inGen)) {
            grunt.fail.warn("generator#inlinegen: paramter 'generator' should be a function");
        }
        return function() {
            var entry = iter();
            if(_.isUndefined(entry)) return;
            var newEntry = inGen(entry, params, flow, depends, data);
